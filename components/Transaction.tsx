  ...
  return (
    <div className="">
      ...
      <div className="hidden md:block">
        <div className="px-12 pt-7 flex flex-row justify-between ">
          <div>
          ...
          <div className="w-[12%] flex justify-center ">
            <p className=" uppercase text-[#84919A] text-[10px]  ">
              Transaction type
            </p>
          </div>
          <div>
          ...
          {table.map(
            ({ amount, id, type, date, time, status1, status2 }, i) => (
              <div className=" flex flex-row mt-6 mx-4" key={i}>
                ...
                <div className="border-b-[1px] ml-[6.5rem] flex justify-between w-[100%] pb-5 ">
                  <div>
                  ...
                  {status1 ? (
                    <div className="border-[1px] border-[#5DC090] bg-[#EFFDED] flex items-center justify-center gap-1 rounded-2xl px-[12px] py-[4px] w-[106px] ">
                      <div className="w-[8px] h-[8px] rounded bg-[#92EF80]"></div>
                      <p className="text-[#144909] text-[14px] ">{status1}</p>
                    </div>
                  ) : (
                    <div className="border-[1px] border-[#F14156] bg-[#FEECEE] flex items-center justify-center gap-1 rounded-2xl px-[12px] py-[4px] w-[106px] ">
